...
# Use factory methods task=create_task instead of relying solely on constructors task=Task()
# because underlying hardware resources may be reused between instantiations
